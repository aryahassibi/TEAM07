                            ...
                            (cartErr) => {
                                if (cartErr) {
                                    ...
                                    return res
                                        .status(500)
                                        .json({
                                            error: "Failed to create shopping cart for user",
                                        });
                                }

                                res.status(201).json({
                                    message:
                                        "User registered successfully and shopping cart created",
                                    userId: userId,
                                });
                            }
                        );
...
router.post("/login", async (req, res) => {
    ...
    const managerQuery =
        "SELECT manager_id, first_name, last_name, password_hash, role FROM Managers WHERE email = ?";
